...
> **Daily V2 冻结通知（2026-09-22）**：旧日报管道存在句子级证据先分类后重组、破坏事件连贯性和制造伪因果的架构缺陷。自动调度、增量生成和全量重建已禁用；请勿按下文历史命令生成旧版日报。根因、新 Event-first 方向和恢复门禁见 [DAILY_PRODUCT_RESET.md](DAILY_PRODUCT_RESET.md)。
